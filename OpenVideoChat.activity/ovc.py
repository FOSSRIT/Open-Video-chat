...
GST_OUTPIPE_BASE = "v4l2src ! videorate ! video/x-raw-yuv,width=320,height=240,framerate=15/1 ! tee name=t ! ffmpegcolorspace ! xvimagesink force-aspect-ratio=true t. ! theoraenc bitrate=50 speed-level=2 ! udpsink host=%s"
